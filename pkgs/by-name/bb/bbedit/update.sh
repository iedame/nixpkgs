...
fetch_darwin() {
  VER="$1"
  URL="https://s3.amazonaws.com/BBSW-download/BBEdit_${VER}.dmg"
...
LATEST_VERSION="$(curl -Ls https://www.barebones.com/support/bbedit/updates.html | xq -q 'h3' | head -n1 | grep -oE '[0-9]+\.[0-9]+\.[0-9]+')"
