...
fetch_darwin() {
  VER="$1"
  URL="https://dist.mountainduck.io/Mountain%20Duck-${VER}.zip"
...
VERSION_INFO="$(curl -Ls https://mountainduck.io/changelog/ | xq -m -q 'a[href*="Mountain%20Duck-"][href*=".zip"]' -a 'href' | head -n1)"
